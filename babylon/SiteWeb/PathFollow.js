function initializeBehavior4() {
    ...
    const createScene = function() {
        ...
        vehicleDirection = new BABYLON.Vector3(Math.random() - 0.5, 0, Math.random() - 0.5).normalize();
        vehicleSpeed = 1;
        ...
        proximityIndicator = BABYLON.Mesh.CreateTorus("proximityIndicator", 10, 0.1, 20, scene, false, BABYLON.Mesh.DOUBLESIDE);
